...
test.describe('Restful Booker Get Booking API Validation', () => {
  ...
  test('@API Get Booking By Lastname', async ({ request }) => {
  ...
  test('@API Get Booking By Firstname', async ({ request }) => {
    const response = await request.get(`${baseURL}/booking`, {
      params: {
        firstname: 'Sally'
      }
  ...
  test('@API Get Booking By Checkout Date', async ({ request }) => {
    const response = await request.get(`${baseURL}/booking`, {
      params: {
        checkout: '2014-10-23'
      }
  ...
  test('@API Get Booking By ID', async ({ request }) => {
    let ID = bookingId
