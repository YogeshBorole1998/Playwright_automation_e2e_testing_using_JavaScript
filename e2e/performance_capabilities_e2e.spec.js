...
test.describe('Capabilities - Performance Testing', () => {
  test('Access the running devtools and request CDP Performance metrics', async ({ page }) => {
  ...
  test('Capture Performance Timeline Trace during test excution and demonstrate marks', async ({ page, browser }) => {
  ...
  test('Route Image Replacement', async ({ page, context }) => {
    ...
    // URL to replace
    const remoteFilePath = 'https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png'
